...
class hybrid_lstm_uni_per(Prediction_model):
    ...
    def lstm_bench(self, train):
        ...
        x_train = np.reshape(x_train, (-1, self.in_num, 1))
        ...
        model.add(LSTM(self.units1, return_sequences=True))
    ...
    def prophet_fit(self):
        ...
        self.df_prophet, dataset, scaler_to_fix_decimal = prophet_data_preperation(self.series_df, self.cap_power)
