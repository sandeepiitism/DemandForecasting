...
#             "GBM": gbm_forecast
    ...
    #                     Params contain the best hyperparameter values for each sku as saved in the hyperparameters file in config folder
                    ...
                    skus_Exception_error = pd.concat([skus_Exception_error,pd.DataFrame({'material_no': [self.detail_df[0]],
                                                                                         'material_name': [self.detail_df[1]],
                                                                                         'market_code': [self.detail_df[2]],
                                                                                         'model_name': [model_name]})], ignore_index=True)
